...
<ui:dspGenericEditForm 	myself= "#myself#"
		...
		<input type="radio" name="admin" id="admin" value="true" class="radio" <cfif record.getAdmin()>checked</cfif> />Yes
		<input type="radio" name="admin" id="admin" value="false" class="radio" <cfif NOT record.getAdmin()>checked</cfif>/>No  <br />
