...
<cfset xfa.rss = "c.viewrss" />
<cfset Controller.getProjectForRSS( event ) >
<cftry>
<cfsavecontent variable="content.pageContent"><cfoutput><cfinclude template="../views/dsp_select_rss.cfm"></cfoutput></cfsavecontent>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 18 and right(cfcatch.MissingFileName,18) is "dsp_select_rss.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse dsp_select_rss.cfm in circuit v which does not exist (from fuseaction c.rss).">
