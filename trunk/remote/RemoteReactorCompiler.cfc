...
<cfcomponent name="RemoteReactorCompiler" 
			displayname="RemoteReactorCompiler:RemoteProxyBean" 
	...
	<cffunction name="setup" access="public" returntype="void">
		...
		<cftry>		
			...
			<cfset remoteFactory = bf.getBean("&reactorCompiler_remote") />
			<cfset variables.target = bf.getBean("reactorCompiler_remote") />
	...
	<cffunction name="setConfig" access="remote" returntype="any" output="false" > 
<cfargument name="Config" type="string" required="true" /> 
<cfset var rtn = callMethod('setConfig', arguments) />
</cffunction>

<cffunction name="compile" access="remote" returntype="any" output="true" > 
<cfargument name="deleteFirst" type="boolean" default="true" /> 
<cfset var rtn = callMethod('compile', arguments) />
</cffunction>

<cffunction name="throwBadConfigPath" access="remote" returntype="any" output="false" > 
<cfargument name="config" type="string" required="true" /> 
<cfset var rtn = callMethod('throwBadConfigPath', arguments) />
</cffunction>

<cffunction name="getConfig" access="remote" returntype="any" output="false" > 
<cfset var rtn = callMethod('getConfig', arguments) />
<cfif isDefined('rtn')><cfreturn rtn /></cfif>
</cffunction>

<cffunction name="setReactorConfiguration" access="remote" returntype="any" output="false" > 
<cfargument name="ReactorConfiguration" type="any" required="true" /> 
<cfset var rtn = callMethod('setReactorConfiguration', arguments) />
</cffunction>

<cffunction name="getReactorConfiguration" access="remote" returntype="any" output="false" > 
<cfset var rtn = callMethod('getReactorConfiguration', arguments) />
<cfif isDefined('rtn')><cfreturn rtn /></cfif>
</cffunction>
