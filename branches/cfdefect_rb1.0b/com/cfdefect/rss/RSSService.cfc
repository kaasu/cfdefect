...
<cffunction name="init" returntype="cfdefect.com.cfdefect.rss.RSSService" output="false" access="public" hint="Constructor">
	<cfargument name="applicationURL" type="string" required="true" hint="" />
	<cfset setApplicationURL( arguments.applicationURL ) />
	<cfreturn this />
</cffunction>

<cffunction name="configure" returntype="void" access="public" output="false" hint="">
	<cfset var meta =  StructNew() />
	<cfset meta.title = getApplicationConfiguration().getConfig( 'AppTitle' )>
	<cfset meta.link = getApplicationURL() />
	<cfset meta.description = getApplicationConfiguration().getConfig( 'AppTitle' ) & ' Site'>
	<cfset setMeta( meta ) />
</cffunction>
...
<cffunction name="generateRSS" returntype="xml" access="public" output="false" hint="">
	...
	<cfset local.issues = getIssues( arguments.projectidfk ) />
...
<cffunction name="getIssues" returntype="query" access="private" output="false" hint="">
	...
	<cfloop query="local.issues">
		...
		<cfset QuerySetCell( local.ret, 'link',  'http://playground.local/cfdefect_site/index.cfm?event=c.issues&projectidfk=' & URLEncodedFormat( projectidfk ) ) />
...
<cffunction name="getApplicationURL" access="private" returntype="string" output="false" hint="Getter for ApplicationURL">
	<cfreturn variables.instance.ApplicationURL />
</cffunction>

<cffunction name="setApplicationURL" access="private" returntype="void" output="false" hint="Setter for ApplicationURL">
	<cfargument name="ApplicationURL" type="string" required="true" />
	<cfset variables.instance.ApplicationURL = arguments.ApplicationURL>
</cffunction>
