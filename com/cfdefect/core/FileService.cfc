...
<cffunction name="configure" returntype="void" access="public" output="false" hint="">
	<cfset setPath( getApplicationConfiguration().getAttachmentPath() ) />
...
<!--- GETTER & SETTER --->
<cffunction name="getApplicationConfiguration" access="public" returntype="cfdefect.com.cfdefect.config.ApplicationConfiguration" output="false" hint="Getter for ApplicationConfiguration">
